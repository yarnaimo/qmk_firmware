...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, KC_F11,  KC_F12,  _______, _______, _______,                   KC_PAUS, KC_P4,   KC_P5,   KC_P6,   KC_PENT, _______, \
    _______, _______, _______, _______, _______, C_X,     C_V,     _______, KC_INS,  KC_P1,   KC_P2,   KC_P3,   KC_PDOT, _______, \
