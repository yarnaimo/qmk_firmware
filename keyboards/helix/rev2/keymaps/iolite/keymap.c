...
// S_CAPS KC_CAPS JP_MHEN
// KC_UP KC_LEFT KC_DOWN KC_RGHT
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_IOLITE] = LAYOUT(
    KC_ESC , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                   KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_DEL , \
    KC_TAB , KC_J   , KC_E   , KC_A   , KC_Y   , JP_HENK,                   KC_F   , KC_G   , KC_K   , KC_R   , KC_P   , KC_BSPC, \
    KC_LALT, KC_C   , KC_O   , KC_U   , KC_I   , JP_ZHTG,                   KC_H   , KC_T   , KC_S   , KC_N   , KC_D   , KC_ENT , \
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 ,                   KC_MUTE, KC_HOME, KC_UP  , KC_END , KC_PGUP, KC_PPLS, \
    _______, KC_F11 , KC_F12 , JP_BSLS, CS_I   , C_SLSH ,                   KC_PAUS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_PENT, \
    _______, JP_CIRC, JP_AT  , JP_LBRC, JP_RBRC, C_X    , C_V    , CS_Z   , KC_INS , _______, _______, _______, _______, KC_PDOT, \
    _______, _______, JP_PIPE, RESET  , AG_SWAP, AG_NORM, _______, _______, _______, _______, _______, _______, _______, _______  \
  ),
};
